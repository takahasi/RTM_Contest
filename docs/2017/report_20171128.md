...
|---|-----|---|--------------|----|-----------|-------------|-------------|----------------|
|01|	実機とシミュレータを併用するロボットプログラミング教材のための支援ツール|OpenRTM-aist|<http://www.openrtm.org/openrtm/ja/project/contest2017_01>|0 components|step|0 errors|0 warnings|0 licences|0 executables|
|---|-----|---|--------------|----|-----------|-------------|-------------|----------------|
|02|	写真撮影ロボット制御のためのRTC群|OpenRTM-aist|<http://www.openrtm.org/openrtm/ja/project/contest2017_02>|0 components|step|0 errors|0 warnings|0 licences|0 executables|
|---|-----|---|--------------|----|-----------|-------------|-------------|----------------|
|03|	深層学習を用いたコンポーネント群の作成|OpenRTM-aist|<http://www.openrtm.org/openrtm/ja/project/contest2017_03>|2 components|  - cpp:            645 (79.53%)
  - xml:            166 (20.47%)step|0 errors|0 warnings|10 licences|0 executables|
|---|-----|---|--------------|----|-----------|-------------|-------------|----------------|
|04|	クラウド型音声認識RTコンポーネントフレームワークの開発|OpenRTM-aist|<http://www.openrtm.org/openrtm/ja/project/contest2017_04>|0 components|step|0 errors|0 warnings|0 licences|0 executables|
|---|-----|---|--------------|----|-----------|-------------|-------------|----------------|
|05|	フェイス・ツゥー・フェイス・カメラRTCの開発|OpenRTM-aist|<http://www.openrtm.org/openrtm/ja/project/contest2017_05>|0 components|step|0 errors|0 warnings|0 licences|0 executables|
|---|-----|---|--------------|----|-----------|-------------|-------------|----------------|
|06|	Choreonoid用OpenRTM連携プラグインPython版|OpenRTM-aist|<http://www.openrtm.org/openrtm/ja/project/contest2017_06>|5 components|  - python:         754 (50.47%)
  - cpp:            599 (40.09%)
  - xml:            141 (9.44%)step|0 errors|23 warnings|19 licences|0 executables|
|---|-----|---|--------------|----|-----------|-------------|-------------|----------------|
|07|	遠隔操作ロボットのための狭路走行RTコンポーネント|OpenRTM-aist|<http://www.openrtm.org/openrtm/ja/project/contest2017_07>|0 components|step|0 errors|0 warnings|0 licences|0 executables|
|---|-----|---|--------------|----|-----------|-------------|-------------|----------------|
|08|	自己完結性を有する小型移動ロボット環境を用いた実演システムの開発|OpenRTM-aist|<http://www.openrtm.org/openrtm/ja/project/contest2017_08>|4 components|  - python:         423 (100.00%)step|0 errors|9 warnings|0 licences|0 executables|
|---|-----|---|--------------|----|-----------|-------------|-------------|----------------|
|09|	RTミドルウェアを用いたロボット操縦とセンサ情報の体験を伴うVRゲーム|OpenRTM-aist|<http://www.openrtm.org/openrtm/ja/project/contest2017_09>|0 components|step|0 errors|0 warnings|0 licences|0 executables|
|---|-----|---|--------------|----|-----------|-------------|-------------|----------------|
|10|	DockerによるRTミドルウェア開発・検証環境の提供|OpenRTM-aist|<http://www.openrtm.org/openrtm/ja/project/contest2017_10>|0 components|  - sh:            9517 (97.98%)
  - python:         196 (2.02%)step|0 errors|0 warnings|1 licences|0 executables|
|---|-----|---|--------------|----|-----------|-------------|-------------|----------------|
